...
**Prerequisites**: NeMo Gym installed ([Getting Started](/latest/get-started/installation))
...
<Card title="Run Evaluation" href="/latest/get-started/quickstart#run-evaluation">
