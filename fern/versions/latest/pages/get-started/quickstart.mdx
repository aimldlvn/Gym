...
Run your agent on a set of tasks and score the results. This example uses the [`mcqa`](https://github.com/NVIDIA-NeMo/Gym/tree/main/resources_servers/mcqa) (multiple-choice Q&A) environment with its included example data.
