...
<Card title="Generation Backend" href="/latest/reference/rl-framework-integration/generation-backend-and-openai-compatible-http-server">
...
<Card title="On-Policy Corrections" href="/latest/reference/rl-framework-integration/openai-compatible-http-server-on-policy-correction">
...
<Card title="Integration Footprint" href="/latest/reference/rl-framework-integration/gym-integration-footprint-and-form-factor">
...
<Card title="Success Criteria" href="/latest/reference/rl-framework-integration/gym-rl-framework-integration-success-criteria">
