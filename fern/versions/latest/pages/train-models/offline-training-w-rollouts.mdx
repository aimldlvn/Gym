...
Transform collected rollouts into training data for supervised fine-tuning (SFT) and direct preference optimization (DPO), then run offline training pipelines.
